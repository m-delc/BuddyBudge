...
10.times do
    Person.create!(
        ...
        savings1: Faker::Number.within(range: 101..1001),
        savings2: Faker::Number.within(range: 101..1001),
        savings3: Faker::Number.within(range: 101..1001),
        savings4: Faker::Number.within(range: 101..1001),
        savings5: Faker::Number.within(range: 101..1001),
        savings6: Faker::Number.within(range: 101..1001),
        goal1: Faker::Number.within(range: 101..1001),
        goal2: Faker::Number.within(range: 101..1001),
        goal3: Faker::Number.within(range: 101..1001),
        goal4: Faker::Number.within(range: 101..1001),
        goal5: Faker::Number.within(range: 101..1001),
        goal6: Faker::Number.within(range: 101..1001),
